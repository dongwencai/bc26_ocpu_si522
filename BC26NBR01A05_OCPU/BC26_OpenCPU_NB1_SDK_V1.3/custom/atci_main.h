...
#define ATCI_LOCAL_QUEUE_LENGTH        (4)
...
#define ATCI_RX_FIFO_SIZE 512
#define ATCI_RX_SIZE 512
...
extern atci_status_t     atci_init(Enum_SerialPort *    port);

extern void     atci_processing(void const * argument);
